...
public class AudioWidgetTest {
    ...
    /**
     * Currently choosing audio is locked into the {@link org.espen.collect.android.tasks.MediaLoadingTask}
     * flow and so we'd need to rip this apart to let us drop support for accepting File as data. In
     * this case it will just grab the name off the file and use {@link org.espen.collect.android.utilities.QuestionMediaManager}
