...
class MediaUtilsTest {
    ...
    private var contentUriProvider = mock<org.espen.collect.android.utilities.ContentUriProvider>()
    ...
    fun `When open file, launch on intentLauncher should be called with proper parameters`() {
        ...
        whenever(
            ...
            Uri.parse("content://org.espen.collect.android.provider/external_files/Android/data/org.espen.collect.android/files/image.png")
        )
        ...
        assertThat(
            ...
            `is`("content://org.espen.collect.android.provider/external_files/Android/data/org.espen.collect.android/files/image.png")
        )
