...
class StoragePathProviderTest {
    ...
    fun odkDirPath_withForms_returnsAndCreatesFormsDirForCurrentProject() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.FORMS)
    ...
    fun odkDirPath_withInstances_returnsAndCreatesInstancesDirForCurrentProject() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.INSTANCES)
    ...
    fun odkDirPath_withMetadata_returnsAndCreatesMetadataDirForCurrentProject() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.METADATA)
    ...
    fun odkDirPath_withCache_returnsAndCreatesCacheDirForCurrentProject() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.CACHE)
    ...
    fun odkDirPath_withLayers_returnsAndCreatesLayersDirForCurrentProject() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.LAYERS)
    ...
    fun odkDirPath_withSettings_returnsAndCreatesSettingsDirForCurrentProject() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.SETTINGS)
    ...
    fun getOdkDirPath_withSharedLayers_returnsAndCreatesSharedLayersDir() {
        val path = storagePathProvider.getOdkDirPath(org.espen.collect.android.storage.StorageSubdirectory.SHARED_LAYERS)
