...
import org.espen.collect.android.widgets.ExVideoWidget;
...
public class ExVideoWidgetTest extends FileWidgetTest<ExVideoWidget> {
    ...
    public void whenFontSizeChanged_CustomFontSizeShouldBeUsed() {
        ...
        assertThat((int) getWidget().binding.captureVideoButton.getTextSize(), is(QuestionFontSizeUtils.getFontSize(settingsProvider.getUnprotectedSettings(), FontSize.LABEL_LARGE)));
        assertThat((int) getWidget().binding.playVideoButton.getTextSize(), is(QuestionFontSizeUtils.getFontSize(settingsProvider.getUnprotectedSettings(), FontSize.LABEL_LARGE)));
    }
