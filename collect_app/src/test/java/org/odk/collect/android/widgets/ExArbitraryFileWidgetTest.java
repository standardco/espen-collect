...
import org.espen.collect.android.widgets.ExArbitraryFileWidget;
...
public class ExArbitraryFileWidgetTest extends FileWidgetTest<ExArbitraryFileWidget> {
    ...
    public void whenFontSizeChanged_CustomFontSizeShouldBeUsed() {
        ...
        assertThat((int) getWidget().binding.exArbitraryFileButton.getTextSize(), is(QuestionFontSizeUtils.getFontSize(settingsProvider.getUnprotectedSettings(), FontSize.LABEL_LARGE)));
