...
import static org.espen.collect.android.javarosawrapper.JavaRosaFormController.INSTANCE_ID;
...
import org.espen.collect.android.exception.BadUrlException;
import org.espen.collect.android.exception.MultipleFoldersFoundException;
...
import org.espen.collect.android.utilities.UrlUtils;
...
public class InstanceGoogleSheetsUploader extends InstanceUploader {
    ...
    private String getInstanceID(List<TreeElement> elements) {
        for (TreeElement element : elements) {
            if (element.getName().equals(JavaRosaFormController.INSTANCE_ID)) {
