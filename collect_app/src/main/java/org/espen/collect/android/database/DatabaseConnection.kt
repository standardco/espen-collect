...
open class DatabaseConnection(
        ...
        private val migrator: org.espen.collect.android.database.DatabaseMigrator,
...
private class DatabaseMigratorSQLiteOpenHelper(
    ...
    version: Int,
    private val databaseMigrator: org.espen.collect.android.database.DatabaseMigrator
