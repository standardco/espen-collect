...
public class LookUpWidget extends BaseSelectListWidget {
    ...
    public LookUpWidget(Context context, QuestionDetails questionDetails, boolean autoAdvance, FormController formController, SelectChoiceLoader selectChoiceLoader) {
