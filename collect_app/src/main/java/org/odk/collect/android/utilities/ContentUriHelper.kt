...
object ContentUriHelper {
    ...
    fun getFileExtensionFromUri(fileUri: Uri): String? {
        val mimeType = EspenCollect.getInstance().contentResolver.getType(fileUri)
        ...
        if (extension == null || extension.isEmpty()) {
            EspenCollect.getInstance().contentResolver.query(fileUri, null, null, null, null).use { cursor ->
